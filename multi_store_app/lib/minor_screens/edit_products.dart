// ignore_for_file: unused_field, sort_child_properties_last, avoid_print
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                              ...
                              validator: (value) {
                                ...
                                } else if (value.isVaidPrice() != true) {
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                              ...
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return null;
                                } else if (value.isVaidDiscount() != true) {
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                          ...
                          validator: (value) {
                            ...
                            } else if (value.isVaidQuantity() != true) {
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                          ...
                          maxLines: 5,
                          decoration: textFormDecoration.copyWith(
                            labelText: 'Procduct description',
