      ...
      child: Container(
        ...
        child: ExpansionTile(
          ...
          subtitle:
            ...
            Text(widget.order['diliverystatus'])
          ]),
          children: [
            Container(
              // height: 200,
              width: double.infinity,
              decoration: BoxDecoration(
                  color: widget.order['diliverystatus'] == 'delivered'
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          (widget.order['diliverystatus']),
                          style: const TextStyle(
                              fontSize: 15, color: Colors.green),
                        ),
                      ],
                    ),
                    widget.order['diliverystatus'] == 'shipping'
                        ? Text(
                            ('Estimated Delivery Date: ') +
                                (DateFormat('yyyy-MM-dd').format(
                                        widget.order['diliverydate'].toDate()))
                                    .toString(),
                            style: const TextStyle(fontSize: 15),
                          )
                        : const Text(''),
                    widget.order['diliverystatus'] == 'delivered' &&
